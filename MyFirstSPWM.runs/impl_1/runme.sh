...
HD_PWD='D:/Vivado Projects/MyFirstSPWM/MyFirstSPWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spwm_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spwm_top.tcl -notrace
