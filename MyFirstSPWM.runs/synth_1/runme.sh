...
HD_PWD='D:/Vivado Projects/MyFirstSPWM/MyFirstSPWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spwm_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spwm_top.tcl
